...
<img src="https://github.com/AsogiPaola/ReconocimientoVocales/blob/main/images/wI.png" width="680"/>

Figura 7: vocales con las características 

Existen diversas maneras de realizar la clasificación ya sea por perceptrón o por medio de redes neuronales, en este caso fue por perceptrón. 
Ya por último se analizó que puede ser probable que, si la recolección de voces se hubiera realizado con un micrófono de mayor fidelidad, lo más probable es que se obtuvieran las gráficas sean más precisas, con una mejor frecuencia de muestreo. 
